...
public class TreasureHunter {
	...
	public static void main(String[] args) throws ClassNotFoundException, ParseException{
		...
		TreasureHunter start = new TreasureHunter();
		/*Get the size of the grid*/
		try{
			m = Integer.parseInt(args[0]);
		    n = Integer.parseInt(args[1]);
		}catch(ArrayIndexOutOfBoundsException e){
			m = Integer.parseInt(JOptionPane.showInputDialog(null,"Please enter the number of the row:\n","preset",JOptionPane.PLAIN_MESSAGE));
			n = Integer.parseInt(JOptionPane.showInputDialog(null,"Please enter the number of the column:\n","preset",JOptionPane.PLAIN_MESSAGE));	
		}
	    bs = new JButton[m][n];
